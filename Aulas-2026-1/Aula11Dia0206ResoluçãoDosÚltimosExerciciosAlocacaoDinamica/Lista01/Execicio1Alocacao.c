...
void filtrarMaioresQue10Pares(int **vetorOriginal, int tamanhoOriginal){
    ...
    for(int indice = 0; indice < tamanhoOriginal; indice++){
        
        int valorAtual = *(*vetorOriginal + indice);
    ...
    printf("Números pares maiores que 10: \n");
    
    for(int indiceDoNovoVetor = 0; indiceDoNovoVetor < tamanhoDoVetorDinamicoComParesMaiorQueDez; indiceDoNovoVetor++){
        printf("%d", *(vetorComParesMaiorQueDez + indiceDoNovoVetor));
        printf(" ");
    }
    printf("\n");
