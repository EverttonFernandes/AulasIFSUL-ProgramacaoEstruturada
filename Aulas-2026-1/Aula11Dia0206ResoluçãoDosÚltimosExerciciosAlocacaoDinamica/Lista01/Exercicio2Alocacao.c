...
int main(){
    ...
    int numero;
    int tamanhoDoVetorDinamicoComImparesMaiorQueDez = 0;
    ...
    int *retornoDoPonteiro = filtrarImparesMaioresQue10(&vetorInicial, tamanhoInicial, &tamanhoDoVetorDinamicoComImparesMaiorQueDez);

    printf("Números ímpares maiores do que 10: \n");
    
    // variavel tamanhoDoVetorDinamicoComImparesMaiorQueDez sendo usada para corrigir eventual lixo de memória ao percorrer o vetor retornado
    if(retornoDoPonteiro != NULL){
        for (int i = 0; i < tamanhoDoVetorDinamicoComImparesMaiorQueDez; i++){ 
...
int *filtrarImparesMaioresQue10(int **vetorOriginal, int tamanhoOriginal, int *tamanhoDoVetorDinamicoComImparesMaiorQueDez){
    int *vetorComImparesMaiorQueDez = NULL;
    ...
    for(int i = 0; i < tamanhoOriginal; i++){
        ...
        if(valorAtual > 10 && valorAtual % 2 != 0){
            vetorComImparesMaiorQueDez = (int *)realloc(vetorComImparesMaiorQueDez, (*tamanhoDoVetorDinamicoComImparesMaiorQueDez + 1 ) * sizeof(int));
            vetorComImparesMaiorQueDez[*tamanhoDoVetorDinamicoComImparesMaiorQueDez] = valorAtual;
            (*tamanhoDoVetorDinamicoComImparesMaiorQueDez)++;
        }
    }

    return vetorComImparesMaiorQueDez;
}
