...
void ordenarCrescente(int **vetor, int tamanho) { // bubble sort nome desse algoritmo de ordenação!
    // VAMOS IMPLEMENTAR A ORDENAÇÃO?
    int quantidadeDeRodadasEfeatuadasParaRealizarTodasAsTrocas = 0;
    while(1){
        ...
        quantidadeDeRodadasEfeatuadasParaRealizarTodasAsTrocas++;
    ...
    printf("Quantidade de rodadas realizadas %d: ", quantidadeDeRodadasEfeatuadasParaRealizarTodasAsTrocas - 1);
}
