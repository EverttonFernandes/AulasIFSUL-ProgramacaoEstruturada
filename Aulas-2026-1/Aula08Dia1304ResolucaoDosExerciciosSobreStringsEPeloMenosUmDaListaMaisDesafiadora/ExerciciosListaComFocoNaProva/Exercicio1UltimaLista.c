...
int removerNegativos(float *ponteiroComOsValoresOriginais, int tamanho){
    ...
    // o ponteiro ponteiroComFloatsPositivos neste momento está apontando para a última posição onde foi colocado um valor >= 0.0, ou seja, 
    // a próxima posição que ele aponta é a primeira posição onde deve ser colocado o valor 0.0, caso haja sobras de posições no vetor original
